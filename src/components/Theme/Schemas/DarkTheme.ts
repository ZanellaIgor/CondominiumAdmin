...
const colors = {
  gradients: {
    blue1: 'linear-gradient(135deg, #000DFF 0%, #6B73FF 100%)',
    blue2: 'linear-gradient(135deg, #0396FF 0%, #ABDCFF 100%)',
    blue3: 'linear-gradient(127.55deg, #243B55 3.73%, #141E30 92.26%)',
    blue4: 'linear-gradient(-20deg, #4e4376 0%, #2b5876 100%)',
    blue5: 'linear-gradient(135deg, #123597 10%, #97ABFF 100%)',
    orange1: 'linear-gradient(135deg, #F55555 0%, #FCCF31 100%)',
    orange2: 'linear-gradient(135deg, #FD6585 0%, #FFD3A5 100%)',
    orange3: 'linear-gradient(120deg, #fda085 0%, #f6d365 100%)',
    purple1: 'linear-gradient(135deg, #9708CC 0%, #43CBFF 100%)',
    purple3: 'linear-gradient(135deg, #764ba2 0%, #667eea 100%)',
    pink1: 'linear-gradient(135deg, #D939CD 0%, #F6CEEC 100%)',
    pink2: 'linear-gradient(135deg, #8C1BAB 0%, #F761A1 100%)',
    green1: 'linear-gradient(135deg, #3CD500 0%, #FFF720 100%)',
    green2: 'linear-gradient(to bottom, #96c93d, #00b09b)',
    black1: 'linear-gradient(100.66deg, #000000 6.56%, #434343 93.57%)',
    black2: 'linear-gradient(60deg, #485563 0%, #29323c 100%)',
  },
  shadows: {
    success:
    ...
    cardSm: '0px 2px 3px rgba(0, 0, 0, .18), 0px 1px 1px rgba(0, 0, 0, 0.32)',
    cardLg:
      '0 5rem 14rem 0 rgb(0 0 0 / 30%), 0 0.8rem 2.3rem rgb(255 255 255 / 60%), 0 0.2rem 0.3rem rgb(255 255 255 / 45%)',
  },
  layout: {
    general: {
      bodyBg: '#121212',
